...
struct sysent sysent[] = {
	...
	{ .sy_narg = AS(inotify_add_watch_args), .sy_call = (sy_call_t *)sys_inotify_add_watch, .sy_auevent = AUE_INOTIFY, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 592 = inotify_add_watch */
