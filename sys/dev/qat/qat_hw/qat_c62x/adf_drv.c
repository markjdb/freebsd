...
DRIVER_MODULE_ORDERED(qat_c62x, pci, adf_driver, adf_devclass, NULL, NULL,
		      SI_ORDER_THIRD);
MODULE_VERSION(qat_c62x, 1);
MODULE_DEPEND(qat_c62x, qat_common, 1, 1, 1);
MODULE_DEPEND(qat_c62x, qat_api, 1, 1, 1);
MODULE_DEPEND(qat_c62x, linuxkpi, 1, 1, 1);
