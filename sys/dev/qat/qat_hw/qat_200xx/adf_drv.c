...
DRIVER_MODULE_ORDERED(qat_200xx, pci, adf_driver, adf_devclass, NULL, NULL,
		      SI_ORDER_THIRD);
MODULE_VERSION(qat_200xx, 1);
MODULE_DEPEND(qat_200xx, qat_common, 1, 1, 1);
MODULE_DEPEND(qat_200xx, qat_api, 1, 1, 1);
MODULE_DEPEND(qat_200xx, linuxkpi, 1, 1, 1);
